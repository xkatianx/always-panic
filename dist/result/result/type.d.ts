 ...
 */
export type DeepReadonly<T> = T extends Date | RegExp | Error ? T : T extends (...args: infer A) => infer R ? (...args: A) => R : T extends readonly (infer U)[] ? readonly DeepReadonly<U>[] : T extends object ? {
...
export interface ResultBase<T, E> {
     ...
     */
    andThen<R extends Result<OkContent<R>, ErrContent<R>>>(fn: (value: T) => R): R | this;
    /**
     ...
     */
    orElse<R extends Result<OkContent<R>, ErrContent<R>>>(fn: (error: E) => R): R | this;
    /**
